#ifndef LIBLYX_FOUNDATION_LYXBUFFER_H_
...
template <class T> class Buffer {
    public:
        ...
        void resize(std::size_t newCapacity, bool preserveContent = true) {
            if (!_ownMem) throw lyx::InvalidAccessException("Cannot resize buffer which does not own its storage.");
...
#endif // LIBLYX_FOUNDATION_LYXBUFFER_H_
